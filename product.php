        ...
        <div class="col-lg-8 mx-auto">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item noBorder">
                    ...
                    <a href="http://localhost/sitio-web-proyecto/detalles.php?id=<?php echo $servicio->getId() ?>"><h5 class="mt-0 font-weight-bold mb-2"><?php echo $servicio->getNombreServicio() ?></h5></a>
